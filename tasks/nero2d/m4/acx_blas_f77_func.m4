#   PLEASE NOTE THAT THIS FILE HAS BEEN HEAVILY MODIFIED BY J. FOSTIER
#   PLEASE FIND THE ORIGINAL FILE FOR YOUR OWN USAGE
#
# SYNOPSIS
#
...
# ZDOTC check (DOUBLE COMPLEX return values)
        AC_MSG_CHECKING([whether ZDOTC is called correctly from Fortran])
        AC_RUN_IFELSE(AC_LANG_PROGRAM(,[[
      double complex zdotc,a(2),b(2),ac(1),w
      external zdotc
      a(1) = dcmplx(1d0,1d0)
      a(2) = dcmplx(2d0,-1d0)
      b(1) = dcmplx(1d0,2d0)
