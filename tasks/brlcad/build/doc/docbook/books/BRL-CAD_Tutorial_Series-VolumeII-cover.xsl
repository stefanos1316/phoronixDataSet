...
<xsl:include href="file:///home/sgeorgiou/GitHub/phoronixDataSet/tasks/brlcad/doc/docbook/resources/brlcad/brlcad-gendata.xsl"/>
<!-- original
<xsl:include href="brlcad-colors-autogen.xsl"/>
-->
<xsl:param name="brlcad.cover.color">#cc6666</xsl:param>
      ...
      <fo:block-container
        ...
        <fo:block>
          <fo:instream-foreign-object content-width='5in' content-height='auto' text-align='center'>
            <xi:include href="/home/sgeorgiou/GitHub/phoronixDataSet/tasks/brlcad/doc/docbook/resources/brlcad/images/brlcad-logo-cc6666.svg" parse='xml'>
