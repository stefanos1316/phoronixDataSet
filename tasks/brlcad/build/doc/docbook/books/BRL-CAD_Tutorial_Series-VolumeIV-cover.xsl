...
-->
<xsl:param name="brlcad.cover.color">#6699cc</xsl:param>
      ...
      <fo:block-container
        ...
        <fo:block>
          <fo:instream-foreign-object content-width='5in' content-height='auto' text-align='center'>
            <xi:include href="/home/sgeorgiou/GitHub/phoronixDataSet/tasks/brlcad/doc/docbook/resources/brlcad/images/brlcad-logo-6699cc.svg" parse='xml'>
