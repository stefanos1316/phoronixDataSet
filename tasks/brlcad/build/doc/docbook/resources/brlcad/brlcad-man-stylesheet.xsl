<xsl:stylesheet
	...
	<xsl:import href="file:////home/sgeorgiou/GitHub/phoronixDataSet/tasks/brlcad/build/doc/docbook/resources/other/standard/xsl/manpages/docbook.xsl"/>
	...
	<!-- Quiet the output from the stylesheet reporting the name created -->
